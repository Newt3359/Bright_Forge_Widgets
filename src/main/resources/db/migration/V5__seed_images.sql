...
SELECT '/uploads/heart-pulse.png', id
FROM widget_info WHERE slug = 'Vitality-4';

INSERT INTO images (image_url, widget_image_fk)
SELECT '/uploads/star.png', id
FROM widget_info WHERE slug = 'StarGazer-2';

INSERT INTO images (image_url, widget_image_fk)
SELECT '/uploads/piggy-bank.png', id
